import 'package:firebase_auth1/Homepage.dart';
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                StringConstant.continueWithGoogle,
                                style: AppStyles.regularText(
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (bilder) => const PhoneAuth()));
                        },
                        child: Container(
                          height: 40,
                          width: double.infinity,
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                StringConstant.continueWithPhone,
                                style: AppStyles.regularText(
                                    fontSize: 15, color: AppColors.black),
                              )
                            ],
